...
const colovalueZ = document.querySelector('#colorZ');

colovalueZ.addEventListener('input', function() {

  document.querySelector('#Smata').style.borderColor = colovalueZ.value;
